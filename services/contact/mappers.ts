/**
 * Contact Service Mappers
 * 
 * Functions for mapping API responses to frontend Contact types.
 */

import { Contact } from '@/types/index';
import { ApiContact, ContactSimpleItem } from './types';
 ...
 */
export const mapApiToContact = (apiContact: ApiContact | any): Contact => {
 ...
 * @throws Error if contact data is invalid
 */
export const mapSimpleItemToContact = (simpleItem: ContactSimpleItem): Contact => {
